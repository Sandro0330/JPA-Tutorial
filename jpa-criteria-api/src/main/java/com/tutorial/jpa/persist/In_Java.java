...
public class In_Java {
	...
	public static void main(String[] args) {
		...
		abstractQuery.where(criteriaBuilder.in(studentRoot.get("s_age")).value(23).value(25));
		...
		//Estudante com idade entre 22 e 24 anos
		System.out.println("Student having age 30 and 36");
